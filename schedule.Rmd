...
Below is our course schedule, which may change as the course progresses. The morning session will run from 9:00-11:00 am and the afternoon session will run from 1:30-3:30 pm (all times EDT/Toronto time).
