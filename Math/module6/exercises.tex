...
\begin{document}
\begin{center}
\Large{Exercises for Module 6: Linear Algebra I}
\end{center}


1.  Let $U$ and $V$ be finite-dimensional vector spaces of the same dimension and let $T: U \to V$ be a linear map. Prove that the following are equivalent:
\begin{itemize}
\item $T$ is bijective 
\item $T$ is injective
