...
\vspace{1in}
\title[]{DoSS Summer Bootcamp Probability \\ Module 9 - 10}
...
\begin{frame}{Counterexamples}
    \begin{block}{a.s. convergence}
    Does a.s. convergence imply $L^p$ convergence for any $p$?
    \end{block}
    \textbf{Counterexample for $p=1$: }
    \vspace{1.8in}
\end{frame}

\begin{frame}{Counterexamples}
    \begin{block}{a.s. convergence}
    Does $L^p$ convergence imply a.s. convergence?
    \end{block}
