...
\begin{frame}{Convergence of functions of random variables}
\textbf{Proof of $X_n + Y_n \xrightarrow[]{a.s.} X + Y$:}
...
\begin{frame}{Convergence of functions of random variables}
\textbf{Proof of $X_n + Y_n \xrightarrow[]{P} X + Y$:}
...
\begin{frame}{Convergence of functions of random variables}
\textbf{Proof of $X_n + Y_n \xrightarrow[]{L^p} X + Y$:}
...
\begin{frame}{Law of large numbers}
    ...
    If $X_1, X_2, \cdots, X_n$ are i.i.d. random variables, $\mu = \mathbb{E}(X_i)$, and $ \mathbb{E}|X_i|< \infty$, then
...
\begin{frame}{Law of large numbers}
    \textbf{Proof of Glivenko-Cantelli theorem:}\\
