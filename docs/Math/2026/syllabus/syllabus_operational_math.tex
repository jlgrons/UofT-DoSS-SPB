...
\section*{Operational Math\\  {\it{DoSS Summer Prep Bootcamp 2026}}}

\section{Time \& Place}
July 6 to 24, online synchronous. Exact times TBA.

\section{Instructor}
\href{mailto:hl.mao@mail.utoronto.ca}{Huanlin Mao}, 2nd year PhD candidate, Department of Statistical Sciences
...
A problem set will be made available for each lecture. All students are expected to submit at least one problem solution (students may submit more) to the instructor via email, \href{mailto:hl.mao@mail.utoronto.ca}{hl.mao@mail.utoronto.ca} within 3 days of the class.
